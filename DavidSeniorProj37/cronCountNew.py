...
for candidate in candidates:
    ...
    if day > 10:
        ...
        dayPlusOne = str(day+1)
    if hour == 9:
        date = "select count(*) from new"+candidate+" where candidate = '"+candidate+"' and created_at > 2016"+month+dayOfMonth+"0"+str(hour)+"0000 and created_at < 2016"+ month + dayOfMonth+str(hour+1)+"0000;"
        print date
    elif hour < 9:
        date = "select count(*) from new"+candidate+" where candidate = '"+candidate+"' and created_at > 2016"+month+dayOfMonth+"0"+str(hour)+"0000 and created_at < 2016"+ month + dayOfMonth + "0"+str(hour+1)+"0000;"
        print date
    elif hour <23:
        date = "select count(*) from new"+candidate+" where candidate = '"+candidate+"' and created_at > 2016"+month+dayOfMonth+str(hour)+"0000 and created_at < 2016"+ month + dayOfMonth+str(hour+1)+"0000;"
        print date
    elif hour==23:
        date = "select count(*) from new"+candidate+" where candidate = '"+candidate+"' and created_at > 2016"+month+dayOfMonth+str(hour)+"0000 and created_at < 2016"+ month + dayOfMonth+str(hour)+"5900;"
        print date
