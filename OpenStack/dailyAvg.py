...
for candidate in list_of_candidates:
    ...
    final_step = session.execute_async('insert into ' + candidate + 'DailyAverages ' + '(start_date, end_date, tweet_count) VALUES (%s, %s, %s)', (int(start_date), int(end_date), int(minute_count[0][0]) ))
