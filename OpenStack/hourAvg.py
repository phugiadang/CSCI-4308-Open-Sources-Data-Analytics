...
print start_date
start_date = calculateDate.subHour(start_date)

end_date = calculateDate.changeHour(start_date)
...
for candidate in list_of_candidates:
    ...
    final_step = session.execute_async('insert into ' + candidate + 'HourAverages ' + '(start_date, end_date, tweet_count) VALUES (%s, %s, %s)', (int(start_date), int(end_date), int(minute_count[0][0]) ))
